...
?>
    ...
    <body>
        <div class="barrinha" id="barrinha">
            <img src="../imagens/LogoRedaQuick_nova.png" alt="Logo RedaQuick" class="configIMGLogoTCC">
        </div>

        <div class="containerSection">
            <section id="sectionCorrigirRedacao">
                <p class="titulo">Menu <br> Abrir Arquivo</p>
                <div class="alinhamentoCentro">
                    <br><br>
                    <input type="file" id="firstUploadPDF" accept=".pdf"><br><br><br>
                    <a href="menu.php"><input id="configBtnVoltarCorrigir" type="button" value="Voltar"></a>
                </div>
            </section>
        </div>
        ...
        <div class="alertaRedacaoCorrigida" id="alertaRedacaoCorrigida">
            <section class="sectionAlertaRedacaoCorrigida">
                <span id="configIconeAlertaRedacaoCorrigida"><i class="bi bi-check2-circle"></i></span>
                <p id="configTextoAlertaRedacaoCorrigida">Esta redação já foi Corrigida!</p>
            </section>
        </div>

        <div class="competencias-container" id="competenciasContainer">
            <section class="competencia">
                ...
                <input type="text" value="200" class="campo-pontuacao" id="competencia1" readonly>
            ...
            <section class="competencia">
                ...
                <input type="text" value="200" class="campo-pontuacao" id="competencia2" readonly>
            ...
            <section class="competencia">
                ...
                <input type="text" value="200" class="campo-pontuacao" id="competencia3" readonly>
            ...
            <section class="competencia">
                ...
                <input type="text" value="200" class="campo-pontuacao" id="competencia4" readonly>
            ...
            <section class="competencia">
                ...
                <input type="text" value="200" class="campo-pontuacao" id="competencia5" readonly>
        ...
        <div id="main-container">
            ...
            <div id="toolbar"><br><br><br>
                ...
                <span style="font-size: 25px"><i class="bi bi-arrow-left-circle" id="voltarPag"
                        onclick="verificaRedacaoSalvaPagAnterior()" title="Página Anterior"></i></span>
                <span style="font-size: 25px"><i class="bi bi-arrow-right-circle" id="passarPag"
                        onclick="verificaRedacaoSalvaProxPag()" title="Próxima Página"></i></span>
            ...
            <div class="elementosLateraisCanvas" id="elementosLateraisCanvas"><br><br><br>
                ...
                <label for="uploadPDF" class="file-upload-label" title="Upload de Arquivo">
